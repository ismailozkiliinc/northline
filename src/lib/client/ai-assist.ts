...
const TYPE_RULES: { id: string; keywords: string[] }[] = [
  {
    id: "mobile",
    keywords: ["mobil", "mobile", "app", "uygulama", "ios", "android", "flutter", "push"],
  },
  {
    id: "ecommerce",
    keywords: [
  ...
  {
    id: "uiux",
    keywords: ["ui", "ux", "tasarım", "design", "figma", "wireframe", "prototip", "prototype"],
  },
  {
    id: "ai",
    keywords: [
  ...
  {
    id: "web",
    keywords: ["web", "site", "website", "landing", "kurumsal", "corporate", "cms", "blog"],
  },
];
...
export function analyzeProjectBrief(text: string, locale: "tr" | "en" = "tr") {
  const { type, features } = classify(text);
  const messages = {
